...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             */
            findInboundCountByClothOfWeekDay(){
                this.$axios({
                    method: "get",
...
//                var data = [[-90], [-20], [46.5], [86.5], [200]];
             ...
             */
            findOutboundCountByClothOfWeekDay(){
                this.$axios({
                    method: "get",
...
//                    console.log(res.data)
                    ...
                    for(var i=0; i < res.data.length;i++) {
                        ...
                        this.factory.push({name:res.data[i].dyeingFactory,value:res.data[i].count})
                    }
            ...
            findOutboundCountByClientNameOfMonth(callback){
                this.$axios({
                    ...
                    for(var i=0; i < res.data.length;i++) {
                        this.client.push({name:res.data[i].clientName,value:res.data[i].count})
                    }
